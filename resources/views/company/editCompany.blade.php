...
<form method="post" enctype="multipart/form-data" action="{{ route('company.update', ['id' => $company->id]) }}">
  ...
  <div class="mb-3">
    ...
    <input type="email" class="form-control" name="CompEmail" id="exampleInputCname" value="{{$company->email}}" aria-describedby="CnameHelp">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    ...
    <input type="text" class="form-control" id="exampleInputCname" value="{{$company->company_url}}" name="CompUrl" aria-describedby="CnameHelp">
  </div>
  <!-- <div class="mb-3">
